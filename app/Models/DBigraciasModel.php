...
WHERE (r.ROOMNAME LIKE '%RKA.KJ%' OR r.ROOMNAME LIKE '%RUC.KJ%' OR r.ROOMNAME LIKE '%RKB.KJ%' OR r.ROOMNAME LIKE '%RKC.KJ%') AND ACTIVESTATUS = 'YA' AND r.ROOMNAME NOT LIKE '%RKA.KJ.SI%'";

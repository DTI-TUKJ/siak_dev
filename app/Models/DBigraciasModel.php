...
class DBigraciasModel extends Model
{
    ...
    public function getClassRoom(){
        $sql ="SELECT r.ROOMID , r.ROOMNAME, r.CAPACITY, r.INFORMATION, r.BUILDINGNAME FROM MASTERDATA.ROOMS r WHERE (r.ROOMNAME LIKE '%KJ%' AND r.INFORMATION LIKE '%RUANG KELAS%'  AND ACTIVESTATUS = 'YA') OR r.ROOMNAME LIKE '%RUC.KJ%'";
